  ...
  const timelineEntries = [
    {
      ...
      description: 'Karuna established Woven With Dream at Jessore Road, Kolkata with a passion for preserving authentic Indian handloom sarees, block printing, and hand painting.'
    },
    {
      year: '2012',
